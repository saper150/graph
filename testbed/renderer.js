...
b2DistanceJoint.prototype.draw = function (transform) {
  renderer.insertLine(this.bodyA.GetTransform().p.x, this.bodyA.GetTransform().p.y,
    this.bodyB.GetTransform().p.x, this.bodyB.GetTransform().p.y,
    0, 0, 0);
}
